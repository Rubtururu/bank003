document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Calcular el porcentaje que representa el usuario de la piscina de dividendos
    const userDividendsAmount = await contract.methods.getUserAvailableDividends(userAccount).call();
    const userDividendsPercentage = (userDividendsAmount / totalDividendsPool) * 100;
    ...
    document.getElementById('user-dividends-percentage').innerText = `${userDividendsPercentage.toFixed(2)}%`; // Mostrar el porcentaje de dividendos del usuario
}
